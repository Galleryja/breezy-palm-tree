...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    size: "6 oz",
    description:
      "Frankincense and myrrh, dry and faintly musky, with a lift that keeps it from sitting heavy. It is the most grounding thing in the range and the one that reads properly unisex. If florals feel cloying to you, start here.",
    notes: [
      {
