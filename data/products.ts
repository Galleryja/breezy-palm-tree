...
export const PRODUCTS: Product[] = [
  {
    ...
    size: "6 oz",
    description:
      "Lighter whipped tallow balm with jasmine, ylang ylang and natural vanilla. This is a beautiful floral blend and a feeling of elevation from the natural elements.",
    notes: [
      {
